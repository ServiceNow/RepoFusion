...
"""
This file contains functionality to set distributed training options for pytorch.
"""
...
def set_distributed_options(opt):
    # adapted from FiD distributed options setting. See: G. Izacard, E. Grave [*Leveraging Passage Retrieval with Generative Models for Open Domain Question Answering*](https://arxiv.org/abs/2007.01282)
    # multi gpu options
